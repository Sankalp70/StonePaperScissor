const rulesBtn = document.querySelectorAll(".rulesbutton");
const nextBtn = document.getElementById("nextbutton");
const playAgainBtn = document.querySelector("#play-again");
const replayBtn = document.querySelector("#replay");
const closeModalBtn = document.getElementById("close");
const rulesModal = document.getElementById("ruleslist");
const wonGame = document.querySelector(".win-game");
const playBoard = document.getElementById("playgame");
const resultBoard = document.getElementById("result-area");
const userResult = document.querySelector(".user-result");
const pcResult = document.querySelector(".computer-result");
